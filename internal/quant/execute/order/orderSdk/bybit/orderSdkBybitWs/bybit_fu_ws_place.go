...
func (s *FutureClient) CreateOrder(req orderModel.MyPlaceOrderReq) error {
	...
	case execute.BUY_OPEN_LIMIT:
		rawData = buyOpenLimit.GetByBitFu_NoSign_u32(req.SymbolName, req.Pvalue, req.Qvalue, req.Pscale, req.Qscale, req.ClientOrderId)
	case execute.SELL_OPEN_LIMIT:
		rawData = sellOpenLimit.GetByBitFu_NoSign_u32(req.SymbolName, req.Pvalue, req.Qvalue, req.Pscale, req.Qscale, req.ClientOrderId)
	case execute.BUY_CLOSE_LIMIT:
		rawData = buyCloseLimit.GetByBitFu_NoSign_u32(req.SymbolName, req.Pvalue, req.Qvalue, req.Pscale, req.Qscale, req.ClientOrderId)
	case execute.SELL_CLOSE_LIMIT:
		rawData = sellCloseLimit.GetByBitFu_NoSign_u32(req.SymbolName, req.Pvalue, req.Qvalue, req.Pscale, req.Qscale, req.ClientOrderId)
	case execute.BUY_OPEN_LIMIT_MAKER:
		rawData = buyOpenLimitMaker.GetByBitFu_NoSign_u32(req.SymbolName, req.Pvalue, req.Qvalue, req.Pscale, req.Qscale, req.ClientOrderId)
	case execute.SELL_OPEN_LIMIT_MAKER:
		rawData = sellOpenLimitMaker.GetByBitFu_NoSign_u32(req.SymbolName, req.Pvalue, req.Qvalue, req.Pscale, req.Qscale, req.ClientOrderId)
	case execute.BUY_CLOSE_LIMIT_MAKER:
		rawData = buyCloseLimitMaker.GetByBitFu_NoSign_u32(req.SymbolName, req.Pvalue, req.Qvalue, req.Pscale, req.Qscale, req.ClientOrderId)
	case execute.SELL_CLOSE_LIMIT_MAKER:
		rawData = sellCloseLimitMaker.GetByBitFu_NoSign_u32(req.SymbolName, req.Pvalue, req.Qvalue, req.Pscale, req.Qscale, req.ClientOrderId)
	case execute.BUY_OPEN_MARKET:
		rawData = buyOpenMarket.GetByBitFu_NoSign_u32(req.SymbolName, req.Qvalue, req.Qscale, req.ClientOrderId)
	case execute.SELL_OPEN_MARKET:
		rawData = sellOpenMarket.GetByBitFu_NoSign_u32(req.SymbolName, req.Qvalue, req.Qscale, req.ClientOrderId)
	}
	if err := s.conn.WriteAsync(rawData); err != nil {
		dynamicLog.Error.GetLog().Errorf("bybit_ws下单错误,请求:%s,错误:%v", string(rawData), err)
		return err
	}
