...
import (
	"context"
	bnOrderTemplate2 "upbitBnServer/internal/quant/exchanges/binance/order/bnOrderTemplate"
...
func (s *TradeManager) SendCancelOrderBy(can *bnOrderTemplate2.CancelTemplate, reqFrom instanceEnum.Type, usageFrom usageEnum.Type, index uint8) error {
...
func (s *TradeManager) SendModifyOrderBy(modify *bnOrderTemplate2.ModifyTemplate, reqFrom instanceEnum.Type, usageFrom usageEnum.Type, index uint8) error {
