...
import (
	...
	"upbitBnServer/internal/quant/exchanges/binance/order/bnOrderSdkWsNoSign"
...
type OrderApp struct {
	rest         *bnAccountSdkRest.FutureRest     // REST API 客户端
	wsOrder      *bnOrderSdkWsNoSign.FutureClient // WS API 客户端
...
func (s *OrderApp) Init(ctx context.Context, v accountConfig.Config) error {
	...
	s.rest = bnAccountSdkRest.NewFutureRest(v.ApiKeyHmac, v.SecretHmac)
	if v.ApiKeyEd25519 != "" {
		s.wsOrder = bnOrderSdkWsNoSign.NewFutureClient(v.ApiKeyEd25519, v.SecretEd25519)
